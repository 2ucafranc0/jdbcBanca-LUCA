...
public class QueryCatalog {
	...
	public static final String selectClientiSenzaConto =
	...
	public static final String selectContiClienteNominativoContenenteValore =
			"SELECT conto.iban, conto.codice_fiscale, conto.valuta, conto.scoperto, conto.data_ora_intestazione\r\n"
	         + "FROM conto  inner join cliente  on conto.codice_fiscale = cliente.codice_fiscale" 
