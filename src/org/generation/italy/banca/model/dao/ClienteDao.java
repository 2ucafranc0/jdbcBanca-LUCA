...
public class ClienteDao extends ADao {
    ...
    public List<Cliente> loadClienteSenzaConto() throws BancaModelException{
    	...
    	try {	
    		...
    		PreparedStatement preparedStatement =								 
             		jdbcConnectionToDatabase.prepareStatement(QueryCatalog.selectClientiSenzaConto);
        ...
        throw new BancaModelException("ClienteDao -> selectClienteSenzaConto"+ sqlException.getMessage());
    }
    return elencoClienti; 
    }
}
